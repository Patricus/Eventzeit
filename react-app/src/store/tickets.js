...
export const addOneTicket = ({attendee, for_sale, user_id, event_id, event_url}) => async dispatch => {
...
export const updateTicket = (id, {attendee, for_sale, user_id, event_id, event_url}) => async dispatch => {
